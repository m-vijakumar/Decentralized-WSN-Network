...
const deviceName = "car2";
const basename = "bs2";
const clustername = "ch1"
...
const requestConnection = async () => {
    ...
    try {
        const result = await instance.methods.Request_of_Connection(basename, clustername, deviceName, destinationDeviceName).call()
        console.log(result)
